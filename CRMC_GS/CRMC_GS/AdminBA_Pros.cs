...
namespace CRMC_GS
{
    public partial class AdminBA_Pros : Form
    {
        ...
        private void AdminBM_Pros_Load(object sender, EventArgs e)
        {
            DisplayRecord();
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("Select *From BA_Pros", con);
        ...
        public void Browse() {
            ...
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BA_Pros where StudentsYear like '" + cbYearLevel.Text + "%' AND Semester like '" + cbsemester.Text + "%'", con);
        ...
        private void txtSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            con = new SqlConnection(connectionstring);
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BA_Pros where Title like '" + txtSearch.Text + "%'", con);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void AdminBA_Pros_FormClosing(object sender, FormClosingEventArgs e)
        {
