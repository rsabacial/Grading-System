...
namespace CRMC_GS
{
    public partial class AdminBSA_Pros : Form
    {
        ...
        public AdminBSA_Pros()
        {
            InitializeComponent();
        }

        private void AdminBSA_Pros_Load(object sender, EventArgs e)
        {
            DisplayRecord();
        }
        private void DisplayRecord()
        {
            SqlCommand cmd = new SqlCommand("Select *From BSA_Pros", con);
        ...
        public void browse() {
            ...
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BSA_Pros where StudentsYear like '" + cbYearLevel.Text + "%' AND Semester like '" + cbsemester.Text + "%'", con);
        ...
        private void AdminBSA_Pros_FormClosing(object sender, FormClosingEventArgs e)
        {
