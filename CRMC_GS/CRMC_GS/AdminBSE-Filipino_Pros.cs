...
namespace CRMC_GS
{
    public partial class AdminBSE_Filipino_Pros : Form
    {
        ...
        public AdminBSE_Filipino_Pros()
        {
            InitializeComponent();
        }

        private void AdminBSE_Filipino_Pros_Load(object sender, EventArgs e)
        {
            DisplayRecord();
        }
        private void DisplayRecord()
        {
            SqlCommand cmd = new SqlCommand("Select *From BSEFilipino_Pros", con);
        ...
        public void browse() {
            ...
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BSEFilipino_Pros where StudentsYear like '" + cbYearLevel.Text + "%' AND Semester like '" + cbsemester.Text + "%'", con);
        ...
        private void txtSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            con = new SqlConnection(connectionstring);
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BSEFilipino_Pros where Title like '" + txtSearch.Text + "%'", con);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void AdminBSE_Filipino_Pros_FormClosing(object sender, FormClosingEventArgs e)
        {
