...
namespace CRMC_GS
{
    public partial class AdminBSHM_Pros : Form
    {
        ...
        public AdminBSHM_Pros()
        {
            InitializeComponent();
        }

        private void AdminBSHM_Pros_Load(object sender, EventArgs e)
        {
            DisplayRecord();
        }
        ...
        public void browse() {
            ...
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BSHM_Pros where StudentsYear like '" + cbYearLevel.Text + "%' AND Semester like '" + cbsemester.Text + "%'", con);
        ...
        {
            SqlCommand cmd = new SqlCommand("Select *From BSHM_Pros", con);
        ...
        private void txtSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            con = new SqlConnection(connectionstring);
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from BSHM_Pros where Title like '" + txtSearch.Text + "%'", con);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void AdminBSHM_Pros_FormClosing(object sender, FormClosingEventArgs e)
        {
