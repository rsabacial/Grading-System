...
namespace CRMC_GS
{
    public partial class AdminCRIMINOLOGY_Pros : Form
    {
        ...
        public AdminCRIMINOLOGY_Pros()
        {
            InitializeComponent();
        }

        private void AdminCRIMINOLOGY_Pros_Load(object sender, EventArgs e)
        {
            DisplayRecord();
        }
         private void DisplayRecord()
        {
            SqlCommand cmd = new SqlCommand("Select *From CRIMINOLOGY_Pros", con);
        ...
        public void browse() {
            ...
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from CRIMINOLOGY_Pros where StudentsYear like '" + cbYearLevel.Text + "%' AND Semester like '" + cbsemester.Text + "%'", con);
        ...
        private void txtSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            con = new SqlConnection(connectionstring);
            con.Open();
            SqlDataAdapter adapt = new SqlDataAdapter("select * from CRIMINOLOGY_Pros where Title like '" + txtSearch.Text + "%'", con);
            DataTable dt = new DataTable();
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void AdminCRIMINOLOGY_Pros_FormClosing(object sender, FormClosingEventArgs e)
        {
