...
namespace CRMC_GS
{
    public partial class TeacherSplitStrangerStudents : Form
    {
        ...
        public TeacherSplitStrangerStudents(string SubjectCode, string SchoolYear, string Semester, string Subject, string Units, string TeacherIDCode,
        ...
        private void TeacherSplitStrangerStudents_Load(object sender, EventArgs e)
        {
            OLDSearchDisplay();
            NewSearchDisplay();
        }
        ...
        private void TeacherSplitStrangerStudents_FormClosing(object sender, FormClosingEventArgs e)
        {
