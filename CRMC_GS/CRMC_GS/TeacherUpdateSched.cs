...
namespace CRMC_GS
{
    public partial class TeacherUpdateSched : Form
    {
        ...
        public TeacherUpdateSched(string SubjectCode, string SchoolYear, string Semester, string Subject, string Units, string TeacherIDCode,
               string TFirstname, string TLastname, string TDepartment, string TCourse, string SchedDay, string Room, string TimeStart, string TmeEnd)
        {    
            InitializeComponent();
        ...
        private void TeacherUpdateSched_Load(object sender, EventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                insertCommand.Parameters.Add("@ShedID", SqlDbType.VarChar).Value = lblAuto.Text;
                ...
                insertCommand.Parameters.Add("@Type", SqlDbType.VarChar).Value = lblType.Text;
