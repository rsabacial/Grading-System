...
namespace CRMC_GS
{
    public partial class TeacherUpdateTranferStudents : Form
    {
        ...
        public TeacherUpdateTranferStudents(string SubjectCode, string SchoolYear, string Semester, string Subject, string Units, string TeacherIDCode,
              string TFirstname, string TLastname, string TDepartment, string TCourse, string Room, string SchedDay, string TimeStart, string TmeEnd,string XRoom,string XSchedDay,string XTimeStart,string XTmeEnd)
        {
            ...
            txtOldRoom.Text = XRoom;
            txtOldSched.Text = XSchedDay;
            txtOTS.Text = XTimeStart;
            txtOTE.Text = XTimeStart;

            txtNewRoom.Text = Room;
            txtSD.Text = SchedDay;
            txtNewTS.Text = TimeStart;
            txtNewTE.Text = TmeEnd;
        }
        ...
        private void TeacherUpdateTranferStudents_Load(object sender, System.EventArgs e)
        {
            OLDSearchDisplay();
        }

        private void TeacherUpdateTranferStudents_FormClosing(object sender, FormClosingEventArgs e)
        {
